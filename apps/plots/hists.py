...
def plot_hists(df: pd.DataFrame, cols: list = None, h: int = None, w: int = None, spacing: float = 0.05,
               ...
               cumulative: bool = False, show_axis: bool = False):
    """plot histogram"""
    ...
    p.update_xaxes(showline=show_axis, linewidth=1, linecolor='grey', showticklabels=show_axis, ticks='')
    p.update_yaxes(showline=show_axis, linewidth=1, linecolor='grey', showticklabels=show_axis, ticks='')
    if h:
